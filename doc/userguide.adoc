...
.2+.^| _<<editableFeatures, editableFeatures>>, +
 <<edgeLabelPosition, image:images/XtextEdgeLabelDirectEditModelDescription.png[] image:images/XtextEdgeLabelDirectEditValueDescription.png[] edgeLabelPosition>>_	
|
