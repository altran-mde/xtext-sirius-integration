...
public class XtextSiriusNodeListViewNodeListCompartment2EditPart extends DNodeListViewNodeListCompartment2EditPart implements IXtextSiriusAwareLabelEditPart {
	private final @NonNull AXtextSiriusDescriptor descriptor;

	public XtextSiriusNodeListViewNodeListCompartment2EditPart(final @NonNull View view, final @NonNull AXtextSiriusDescriptor descriptor) {
		super(view);
