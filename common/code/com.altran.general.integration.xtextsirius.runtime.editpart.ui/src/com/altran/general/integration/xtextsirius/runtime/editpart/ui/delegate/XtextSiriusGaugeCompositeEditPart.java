...
public class XtextSiriusGaugeCompositeEditPart extends GaugeCompositeEditPart implements IXtextSiriusAwareLabelEditPart {
	private final @NonNull AXtextSiriusDescriptor descriptor;

	public XtextSiriusGaugeCompositeEditPart(final @NonNull View view, final @NonNull AXtextSiriusDescriptor descriptor) {
		super(view);
