...
public class XtextSiriusNodeContainerViewNodeContainerCompartmentEditPart
		extends DNodeContainerViewNodeContainerCompartmentEditPart implements IXtextSiriusAwareLabelEditPart {
	private final @NonNull AXtextSiriusDescriptor descriptor;
	
	public XtextSiriusNodeContainerViewNodeContainerCompartmentEditPart(final @NonNull View view,
