...
public class XtextSiriusNodeContainerEditPart extends DNodeContainerEditPart implements IXtextSiriusAwareLabelEditPart {
	private final @NonNull AXtextSiriusDescriptor descriptor;

	public XtextSiriusNodeContainerEditPart(final @NonNull View view, final @NonNull AXtextSiriusDescriptor descriptor) {
		super(view);
