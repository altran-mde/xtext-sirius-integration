...
public class XtextSiriusNodeContainerName2EditPart extends DNodeContainerName2EditPart implements IXtextSiriusAwareLabelEditPart {
	private final @NonNull AXtextSiriusDescriptor descriptor;

	public XtextSiriusNodeContainerName2EditPart(final @NonNull View view, final @NonNull AXtextSiriusDescriptor descriptor) {
		super(view);
