...
public class XtextSiriusNodeContainerViewNodeContainerCompartment2EditPart extends DNodeContainerViewNodeContainerCompartment2EditPart implements IXtextSiriusAwareLabelEditPart {
	private final @NonNull AXtextSiriusDescriptor descriptor;

	public XtextSiriusNodeContainerViewNodeContainerCompartment2EditPart(final @NonNull View view, final @NonNull AXtextSiriusDescriptor descriptor) {
		super(view);
