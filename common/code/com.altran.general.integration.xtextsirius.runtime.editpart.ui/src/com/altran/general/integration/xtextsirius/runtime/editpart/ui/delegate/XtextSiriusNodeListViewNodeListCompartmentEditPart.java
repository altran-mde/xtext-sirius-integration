...
public class XtextSiriusNodeListViewNodeListCompartmentEditPart extends DNodeListViewNodeListCompartmentEditPart implements IXtextSiriusAwareLabelEditPart {
	private final @NonNull AXtextSiriusDescriptor descriptor;

	public XtextSiriusNodeListViewNodeListCompartmentEditPart(final @NonNull View view, final @NonNull AXtextSiriusDescriptor descriptor) {
		super(view);
