...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Eef Xtext Multi Line Value Description</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.altran.general.integration.xtextsirius.model.eef.eefxtext.impl.EefXtextMultiLineValueDescriptionImpl#getPrefixTextExpression <em>Prefix Text Expression</em>}</li>
 *   <li>{@link com.altran.general.integration.xtextsirius.model.eef.eefxtext.impl.EefXtextMultiLineValueDescriptionImpl#getSuffixTextExpression <em>Suffix Text Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EefXtextMultiLineValueDescriptionImpl extends IEefXtextDescriptionImpl
	 ...
	 * @generated
	 */
	protected EefXtextMultiLineValueDescriptionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EefxtextPackage.Literals.EEF_XTEXT_MULTI_LINE_VALUE_DESCRIPTION;
	}
	...
	public void setPrefixTextExpression(String newPrefixTextExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EefxtextPackage.EEF_XTEXT_MULTI_LINE_VALUE_DESCRIPTION__PREFIX_TEXT_EXPRESSION,
	...
	public void setSuffixTextExpression(String newSuffixTextExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EefxtextPackage.EEF_XTEXT_MULTI_LINE_VALUE_DESCRIPTION__SUFFIX_TEXT_EXPRESSION,
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == IEefXtextValueDescription.class) {
			...
			case EefxtextPackage.IEEF_XTEXT_VALUE_DESCRIPTION__PREFIX_TEXT_EXPRESSION:
				return EefxtextPackage.EEF_XTEXT_MULTI_LINE_VALUE_DESCRIPTION__PREFIX_TEXT_EXPRESSION;
			case EefxtextPackage.IEEF_XTEXT_VALUE_DESCRIPTION__SUFFIX_TEXT_EXPRESSION:
				return EefxtextPackage.EEF_XTEXT_MULTI_LINE_VALUE_DESCRIPTION__SUFFIX_TEXT_EXPRESSION;
			default:
				return -1;
			}
		}
...
} //EefXtextMultiLineValueDescriptionImpl
