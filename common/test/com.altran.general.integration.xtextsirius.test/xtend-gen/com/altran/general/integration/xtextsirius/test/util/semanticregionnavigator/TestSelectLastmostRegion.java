...
public class TestSelectLastmostRegion extends ARegion {
	...
	public void singleEntry() {
		...
		final ISemanticRegion semanticRegion = IterableExtensions
				.<ISemanticRegion> head(eventRegion.getSemanticRegions());
		final ISemanticRegion lastmost = SemanticRegionNavigator.getInstance().selectLastmostRegion(
				IterableExtensions.<ISemanticRegion> toSet(Collections.<ISemanticRegion> unmodifiableList(
						CollectionLiterals.<ISemanticRegion> newArrayList(semanticRegion))));
	...
	public void manyEntries() {
		...
		final List<ISemanticRegion> regions = IterableExtensions
				.<ISemanticRegion> toList(eventRegion.getSemanticRegions());
		final Random _random = new Random(31337);
		Collections.shuffle(regions, _random);
		final ISemanticRegion lastmost = SemanticRegionNavigator.getInstance()
				.selectLastmostRegion(IterableExtensions.<ISemanticRegion> toSet(regions));
