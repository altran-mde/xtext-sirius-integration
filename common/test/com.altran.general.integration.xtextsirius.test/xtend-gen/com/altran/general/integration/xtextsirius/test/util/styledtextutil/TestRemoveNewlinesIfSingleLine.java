...
public class TestRemoveNewlinesIfSingleLine extends AFowlerdslDefaultModelTest {
	...
	public void nothing_singleLine() {
		...
		final StringBuffer result = StyledTextUtil.getInstance().removeNewlinesIfSingleLine(text, 0, text.length(),
				false);
	...
	public void simple_singleLine_region() {
		...
		final TextRegion _textRegion = new TextRegion(0, _length);
