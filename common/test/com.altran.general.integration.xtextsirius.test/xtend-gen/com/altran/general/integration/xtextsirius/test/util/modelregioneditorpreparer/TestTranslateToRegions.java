...
public class TestTranslateToRegions extends AModelRegionEditorPreparer {
	...
	public void emptyFeatures() {
		...
		final Set<ISemanticRegion> regions = preparer
				.translateToRegions(CollectionLiterals.<EStructuralFeature> emptySet(), eventRegion, event, rootRegion);
	...
	public void oneDefinedFeature() {
		...
		final Set<ISemanticRegion> regions = preparer.translateToRegions(((Set<EStructuralFeature>) _set), eventRegion,
				event, rootRegion);
	...
	public void someDefinedFeatures() {
		...
		final Function1<ISemanticRegion, Boolean> _function = (final ISemanticRegion it) -> {
			final EObject _semanticElement = it.getSemanticElement();
