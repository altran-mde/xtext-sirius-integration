...
public class TestProxify extends ATestFakeResourceUtil {
	...
	public void proxify() {
		...
		Assert.assertEquals(proxyUri, getAccessibleFakeResourceUtil().removeSynthetic(proxyUri));
