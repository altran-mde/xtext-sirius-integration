...
public class XtextSiriusNodeList2EditPart extends DNodeList2EditPart implements IXtextSiriusAwareLabelEditPart {
	private final @NonNull IXtextSiriusEditpartDescriptor descriptor;
	
	public XtextSiriusNodeList2EditPart(final @NonNull View view, final @NonNull IXtextSiriusEditpartDescriptor descriptor) {
		super(view);
