...
public class XtextSiriusNode3EditPart extends DNode3EditPart implements IXtextSiriusAwareLabelEditPart {
	private final @NonNull IXtextSiriusEditpartDescriptor descriptor;
	
	public XtextSiriusNode3EditPart(final @NonNull View view, final @NonNull IXtextSiriusEditpartDescriptor descriptor) {
		super(view);
