...
public class XtextSiriusNodeContainerNameEditPart extends DNodeContainerNameEditPart
		implements IXtextSiriusAwareLabelEditPart {
	private final @NonNull AXtextSiriusDescriptor descriptor;
	
	public XtextSiriusNodeContainerNameEditPart(final @NonNull View view,
