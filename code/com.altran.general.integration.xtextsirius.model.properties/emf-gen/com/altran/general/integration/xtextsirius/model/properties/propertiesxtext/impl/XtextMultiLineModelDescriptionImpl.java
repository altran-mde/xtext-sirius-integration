 ...
 * <li>{@link com.altran.general.integration.xtextsirius.model.properties.propertiesxtext.impl.XtextMultiLineModelDescriptionImpl#isEnableFormatter
...
public class XtextMultiLineModelDescriptionImpl extends TextAreaDescriptionImpl
	...
	public void setEnableFormatter(final boolean newEnableFormatter) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET,
					PropertiesxtextPackage.XTEXT_MULTI_LINE_MODEL_DESCRIPTION__ENABLE_FORMATTER, oldEnableFormatter,
	...
	public EList<String> getIgnoredNestedFeatures() {
		if (this.ignoredNestedFeatures == null) {
			this.ignoredNestedFeatures = new EDataTypeEList<>(String.class, this,
					PropertiesxtextPackage.XTEXT_MULTI_LINE_MODEL_DESCRIPTION__IGNORED_NESTED_FEATURES);
		}
		...
		if (baseClass == IXtextDescription.class) {
			switch (baseFeatureID) {
				...
				case XtextsiriusPackage.IXTEXT_DESCRIPTION__ENABLE_FORMATTER:
					return PropertiesxtextPackage.XTEXT_MULTI_LINE_MODEL_DESCRIPTION__ENABLE_FORMATTER;
				default:
					return -1;
			}
		}
