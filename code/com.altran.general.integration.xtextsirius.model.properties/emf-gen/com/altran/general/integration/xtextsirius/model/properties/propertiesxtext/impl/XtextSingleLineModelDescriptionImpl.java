 ...
 * <li>{@link com.altran.general.integration.xtextsirius.model.properties.propertiesxtext.impl.XtextSingleLineModelDescriptionImpl#getPrefixTextExpression
 * <em>Prefix Text Expression</em>}</li>
 * <li>{@link com.altran.general.integration.xtextsirius.model.properties.propertiesxtext.impl.XtextSingleLineModelDescriptionImpl#getSuffixTextExpression
...
public class XtextSingleLineModelDescriptionImpl extends TextDescriptionImpl
	...
	public void setPrefixTextExpression(final String newPrefixTextExpression) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET,
					PropertiesxtextPackage.XTEXT_SINGLE_LINE_MODEL_DESCRIPTION__PREFIX_TEXT_EXPRESSION,
	...
	public void setSuffixTextExpression(final String newSuffixTextExpression) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET,
					PropertiesxtextPackage.XTEXT_SINGLE_LINE_MODEL_DESCRIPTION__SUFFIX_TEXT_EXPRESSION,
		...
		if (baseClass == IXtextDescription.class) {
			switch (baseFeatureID) {
				...
				case XtextsiriusPackage.IXTEXT_DESCRIPTION__PREFIX_TEXT_EXPRESSION:
					return PropertiesxtextPackage.XTEXT_SINGLE_LINE_MODEL_DESCRIPTION__PREFIX_TEXT_EXPRESSION;
				case XtextsiriusPackage.IXTEXT_DESCRIPTION__SUFFIX_TEXT_EXPRESSION:
					return PropertiesxtextPackage.XTEXT_SINGLE_LINE_MODEL_DESCRIPTION__SUFFIX_TEXT_EXPRESSION;
				default:
					return -1;
			}
		}
