...
public class ViewpointxtextSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ViewpointxtextPackage.IXTEXT_EDGE_LABEL_DIRECT_EDIT_DESCRIPTION: {
			IXtextEdgeLabelDirectEditDescription iXtextEdgeLabelDirectEditDescription = (IXtextEdgeLabelDirectEditDescription) theEObject;
		...
		case ViewpointxtextPackage.XTEXT_EDGE_LABEL_DIRECT_EDIT_MODEL_DESCRIPTION: {
			XtextEdgeLabelDirectEditModelDescription xtextEdgeLabelDirectEditModelDescription = (XtextEdgeLabelDirectEditModelDescription) theEObject;
		...
		case ViewpointxtextPackage.XTEXT_EDGE_LABEL_DIRECT_EDIT_VALUE_DESCRIPTION: {
			XtextEdgeLabelDirectEditValueDescription xtextEdgeLabelDirectEditValueDescription = (XtextEdgeLabelDirectEditValueDescription) theEObject;
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>IXtext Edge Label Direct Edit Description</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>IXtext Edge Label Direct Edit Description</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIXtextEdgeLabelDirectEditDescription(IXtextEdgeLabelDirectEditDescription object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Xtext Edge Label Direct Edit Model Description</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Xtext Edge Label Direct Edit Model Description</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseXtextEdgeLabelDirectEditModelDescription(XtextEdgeLabelDirectEditModelDescription object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Xtext Edge Label Direct Edit Value Description</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Xtext Edge Label Direct Edit Value Description</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseXtextEdgeLabelDirectEditValueDescription(XtextEdgeLabelDirectEditValueDescription object) {
		return null;
	}
