 ...
 * End Label Style Value Description</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link com.altran.general.integration.xtextsirius.model.diagram.diagramxtext.impl.XtextEndLabelStyleValueDescriptionImpl#getInjectorId
 * <em>Injector Id</em>}</li>
 * <li>{@link com.altran.general.integration.xtextsirius.model.diagram.diagramxtext.impl.XtextEndLabelStyleValueDescriptionImpl#isMultiLine
 * <em>Multi Line</em>}</li>
 * <li>{@link com.altran.general.integration.xtextsirius.model.diagram.diagramxtext.impl.XtextEndLabelStyleValueDescriptionImpl#getPrefixTextExpression
 * <em>Prefix Text Expression</em>}</li>
 * <li>{@link com.altran.general.integration.xtextsirius.model.diagram.diagramxtext.impl.XtextEndLabelStyleValueDescriptionImpl#getSuffixTextExpression
 * <em>Suffix Text Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class XtextEndLabelStyleValueDescriptionImpl extends EndLabelStyleDescriptionImpl
		implements XtextEndLabelStyleValueDescription {
	/**
	 ...
	 * @generated
	 */
	protected XtextEndLabelStyleValueDescriptionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return DiagramxtextPackage.Literals.XTEXT_END_LABEL_STYLE_VALUE_DESCRIPTION;
	}
	...
	public void setInjectorId(final String newInjectorId) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET,
					DiagramxtextPackage.XTEXT_END_LABEL_STYLE_VALUE_DESCRIPTION__INJECTOR_ID, oldInjectorId,
					this.injectorId));
		}
	}
	...
	public void setMultiLine(final boolean newMultiLine) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET,
					DiagramxtextPackage.XTEXT_END_LABEL_STYLE_VALUE_DESCRIPTION__MULTI_LINE, oldMultiLine,
					this.multiLine));
		}
	}
	...
	public void setPrefixTextExpression(final String newPrefixTextExpression) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET,
					DiagramxtextPackage.XTEXT_END_LABEL_STYLE_VALUE_DESCRIPTION__PREFIX_TEXT_EXPRESSION,
	...
	public void setSuffixTextExpression(final String newSuffixTextExpression) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET,
					DiagramxtextPackage.XTEXT_END_LABEL_STYLE_VALUE_DESCRIPTION__SUFFIX_TEXT_EXPRESSION,
	...
	public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
		switch (featureID) {
			case DiagramxtextPackage.XTEXT_END_LABEL_STYLE_VALUE_DESCRIPTION__INJECTOR_ID:
				return getInjectorId();
			case DiagramxtextPackage.XTEXT_END_LABEL_STYLE_VALUE_DESCRIPTION__MULTI_LINE:
				return isMultiLine();
			case DiagramxtextPackage.XTEXT_END_LABEL_STYLE_VALUE_DESCRIPTION__PREFIX_TEXT_EXPRESSION:
				return getPrefixTextExpression();
			case DiagramxtextPackage.XTEXT_END_LABEL_STYLE_VALUE_DESCRIPTION__SUFFIX_TEXT_EXPRESSION:
		...
		if (baseClass == IXtextDescription.class) {
			switch (baseFeatureID) {
				case XtextsiriusPackage.IXTEXT_DESCRIPTION__INJECTOR_ID:
					return DiagramxtextPackage.XTEXT_END_LABEL_STYLE_VALUE_DESCRIPTION__INJECTOR_ID;
				default:
					return -1;
			}
		}
		if (baseClass == IXtextDirectEditDescription.class) {
			switch (baseFeatureID) {
				case XtextsiriusPackage.IXTEXT_DIRECT_EDIT_DESCRIPTION__MULTI_LINE:
					return DiagramxtextPackage.XTEXT_END_LABEL_STYLE_VALUE_DESCRIPTION__MULTI_LINE;
				default:
					return -1;
			}
		}
		if (baseClass == IXtextValueDescription.class) {
			switch (baseFeatureID) {
				case XtextsiriusPackage.IXTEXT_VALUE_DESCRIPTION__PREFIX_TEXT_EXPRESSION:
					return DiagramxtextPackage.XTEXT_END_LABEL_STYLE_VALUE_DESCRIPTION__PREFIX_TEXT_EXPRESSION;
				case XtextsiriusPackage.IXTEXT_VALUE_DESCRIPTION__SUFFIX_TEXT_EXPRESSION:
					return DiagramxtextPackage.XTEXT_END_LABEL_STYLE_VALUE_DESCRIPTION__SUFFIX_TEXT_EXPRESSION;
				default:
					return -1;
			}
		}
...
} // XtextEndLabelStyleValueDescriptionImpl
