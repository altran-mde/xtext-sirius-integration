 ...
 * Center Label Style Model Description</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link com.altran.general.integration.xtextsirius.model.diagram.diagramxtext.impl.XtextCenterLabelStyleModelDescriptionImpl#getInjectorId
 * <em>Injector Id</em>}</li>
 * <li>{@link com.altran.general.integration.xtextsirius.model.diagram.diagramxtext.impl.XtextCenterLabelStyleModelDescriptionImpl#isMultiLine
 * <em>Multi Line</em>}</li>
 * <li>{@link com.altran.general.integration.xtextsirius.model.diagram.diagramxtext.impl.XtextCenterLabelStyleModelDescriptionImpl#getEditableFeatures
 * <em>Editable Features</em>}</li>
 * </ul>
 *
 * @generated
 */
public class XtextCenterLabelStyleModelDescriptionImpl extends CenterLabelStyleDescriptionImpl
		implements XtextCenterLabelStyleModelDescription {
	/**
	 ...
	 * @generated
	 */
	protected XtextCenterLabelStyleModelDescriptionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return DiagramxtextPackage.Literals.XTEXT_CENTER_LABEL_STYLE_MODEL_DESCRIPTION;
	}
	...
	public void setInjectorId(final String newInjectorId) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET,
					DiagramxtextPackage.XTEXT_CENTER_LABEL_STYLE_MODEL_DESCRIPTION__INJECTOR_ID, oldInjectorId,
					this.injectorId));
		}
	}
	...
	public void setMultiLine(final boolean newMultiLine) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET,
					DiagramxtextPackage.XTEXT_CENTER_LABEL_STYLE_MODEL_DESCRIPTION__MULTI_LINE, oldMultiLine,
					this.multiLine));
		}
	}
	...
	public EList<String> getEditableFeatures() {
		if (this.editableFeatures == null) {
			this.editableFeatures = new EDataTypeEList<>(String.class, this,
					DiagramxtextPackage.XTEXT_CENTER_LABEL_STYLE_MODEL_DESCRIPTION__EDITABLE_FEATURES);
		}
	...
	public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
		switch (featureID) {
			case DiagramxtextPackage.XTEXT_CENTER_LABEL_STYLE_MODEL_DESCRIPTION__INJECTOR_ID:
				return getInjectorId();
			case DiagramxtextPackage.XTEXT_CENTER_LABEL_STYLE_MODEL_DESCRIPTION__MULTI_LINE:
				return isMultiLine();
			case DiagramxtextPackage.XTEXT_CENTER_LABEL_STYLE_MODEL_DESCRIPTION__EDITABLE_FEATURES:
		...
		if (baseClass == IXtextDescription.class) {
			switch (baseFeatureID) {
				case XtextsiriusPackage.IXTEXT_DESCRIPTION__INJECTOR_ID:
					return DiagramxtextPackage.XTEXT_CENTER_LABEL_STYLE_MODEL_DESCRIPTION__INJECTOR_ID;
				default:
					return -1;
			}
		}
		if (baseClass == IXtextDirectEditDescription.class) {
			switch (baseFeatureID) {
				case XtextsiriusPackage.IXTEXT_DIRECT_EDIT_DESCRIPTION__MULTI_LINE:
					return DiagramxtextPackage.XTEXT_CENTER_LABEL_STYLE_MODEL_DESCRIPTION__MULTI_LINE;
				default:
					return -1;
			}
		}
		...
		if (baseClass == IXtextDirectEditModelDescription.class) {
			switch (baseFeatureID) {
				case DiagramxtextPackage.IXTEXT_DIRECT_EDIT_MODEL_DESCRIPTION__EDITABLE_FEATURES:
					return DiagramxtextPackage.XTEXT_CENTER_LABEL_STYLE_MODEL_DESCRIPTION__EDITABLE_FEATURES;
				default:
					return -1;
			}
		}
...
} // XtextCenterLabelStyleModelDescriptionImpl
