 ...
 * End Label Style Model Description</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link com.altran.general.integration.xtextsirius.model.diagram.diagramxtext.impl.XtextEndLabelStyleModelDescriptionImpl#getInjectorId
 * <em>Injector Id</em>}</li>
 * <li>{@link com.altran.general.integration.xtextsirius.model.diagram.diagramxtext.impl.XtextEndLabelStyleModelDescriptionImpl#isMultiLine
 * <em>Multi Line</em>}</li>
 * <li>{@link com.altran.general.integration.xtextsirius.model.diagram.diagramxtext.impl.XtextEndLabelStyleModelDescriptionImpl#getEditableFeatures
 * <em>Editable Features</em>}</li>
 * </ul>
 *
 * @generated
 */
public class XtextEndLabelStyleModelDescriptionImpl extends EndLabelStyleDescriptionImpl
		implements XtextEndLabelStyleModelDescription {
	/**
	 ...
	 * @generated
	 */
	protected XtextEndLabelStyleModelDescriptionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return DiagramxtextPackage.Literals.XTEXT_END_LABEL_STYLE_MODEL_DESCRIPTION;
	}
	...
	public void setInjectorId(final String newInjectorId) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET,
					DiagramxtextPackage.XTEXT_END_LABEL_STYLE_MODEL_DESCRIPTION__INJECTOR_ID, oldInjectorId,
					this.injectorId));
		}
	}
	...
	public void setMultiLine(final boolean newMultiLine) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET,
					DiagramxtextPackage.XTEXT_END_LABEL_STYLE_MODEL_DESCRIPTION__MULTI_LINE, oldMultiLine,
					this.multiLine));
		}
	}
	...
	public EList<String> getEditableFeatures() {
		if (this.editableFeatures == null) {
			this.editableFeatures = new EDataTypeEList<>(String.class, this,
					DiagramxtextPackage.XTEXT_END_LABEL_STYLE_MODEL_DESCRIPTION__EDITABLE_FEATURES);
		}
		...
		if (baseClass == IXtextDescription.class) {
			switch (baseFeatureID) {
				case XtextsiriusPackage.IXTEXT_DESCRIPTION__INJECTOR_ID:
					return DiagramxtextPackage.XTEXT_END_LABEL_STYLE_MODEL_DESCRIPTION__INJECTOR_ID;
				default:
					return -1;
			}
		}
		if (baseClass == IXtextDirectEditDescription.class) {
			switch (baseFeatureID) {
				case XtextsiriusPackage.IXTEXT_DIRECT_EDIT_DESCRIPTION__MULTI_LINE:
					return DiagramxtextPackage.XTEXT_END_LABEL_STYLE_MODEL_DESCRIPTION__MULTI_LINE;
				default:
					return -1;
			}
		}
		...
		if (baseClass == IXtextDirectEditModelDescription.class) {
			switch (baseFeatureID) {
				case DiagramxtextPackage.IXTEXT_DIRECT_EDIT_MODEL_DESCRIPTION__EDITABLE_FEATURES:
					return DiagramxtextPackage.XTEXT_END_LABEL_STYLE_MODEL_DESCRIPTION__EDITABLE_FEATURES;
				default:
					return -1;
			}
		}
...
} // XtextEndLabelStyleModelDescriptionImpl
