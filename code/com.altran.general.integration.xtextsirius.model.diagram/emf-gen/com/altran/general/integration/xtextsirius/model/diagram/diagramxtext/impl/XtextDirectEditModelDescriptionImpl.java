 ...
 * <li>{@link com.altran.general.integration.xtextsirius.model.diagram.diagramxtext.impl.XtextDirectEditModelDescriptionImpl#isCancelOnValidationError
 * <em>Cancel On Validation Error</em>}</li>
 * <li>{@link com.altran.general.integration.xtextsirius.model.diagram.diagramxtext.impl.XtextDirectEditModelDescriptionImpl#isEnableFormatter
...
public class XtextDirectEditModelDescriptionImpl extends AXtextDirectEditLabelImpl
	...
	public void setCancelOnValidationError(final boolean newCancelOnValidationError) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET,
					DiagramxtextPackage.XTEXT_DIRECT_EDIT_MODEL_DESCRIPTION__CANCEL_ON_VALIDATION_ERROR,
	...
	public void setEnableFormatter(final boolean newEnableFormatter) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET,
					DiagramxtextPackage.XTEXT_DIRECT_EDIT_MODEL_DESCRIPTION__ENABLE_FORMATTER, oldEnableFormatter,
	...
	public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
		switch (featureID) {
			...
			case DiagramxtextPackage.XTEXT_DIRECT_EDIT_MODEL_DESCRIPTION__CANCEL_ON_VALIDATION_ERROR:
				return isCancelOnValidationError();
			case DiagramxtextPackage.XTEXT_DIRECT_EDIT_MODEL_DESCRIPTION__ENABLE_FORMATTER:
		...
		if (baseClass == IXtextDescription.class) {
			switch (baseFeatureID) {
				...
				case XtextsiriusPackage.IXTEXT_DESCRIPTION__CANCEL_ON_VALIDATION_ERROR:
					return DiagramxtextPackage.XTEXT_DIRECT_EDIT_MODEL_DESCRIPTION__CANCEL_ON_VALIDATION_ERROR;
				case XtextsiriusPackage.IXTEXT_DESCRIPTION__ENABLE_FORMATTER:
					return DiagramxtextPackage.XTEXT_DIRECT_EDIT_MODEL_DESCRIPTION__ENABLE_FORMATTER;
				default:
					return -1;
			}
		}
