...
public class TestCollectToTerminalText extends ARequiredGrammarTerminalsPresentEnsurer {
  ...
  public void noTerminals() {
    ...
    final Function1<ISemanticRegion, EObject> _function = new Function1<ISemanticRegion, EObject>() {
      @Override
      public EObject apply(final ISemanticRegion it) {
    ...
    final Function1<AbstractElement, Boolean> _function_1 = new Function1<AbstractElement, Boolean>() {
      @Override
    ...
    AccessibleRequiredGrammarTerminalsPresentEnsurer _fakeEnsurer = this.getFakeEnsurer();
    final Procedure1<AccessibleRequiredGrammarTerminalsPresentEnsurer> _function_2 = new Procedure1<AccessibleRequiredGrammarTerminalsPresentEnsurer>() {
      @Override
      public void apply(final AccessibleRequiredGrammarTerminalsPresentEnsurer it) {
        it.setGrammarElement(grElement);
      }
  ...
  public void severalTerminals() {
    ...
    final Function1<ISemanticRegion, EObject> _function_5 = new Function1<ISemanticRegion, EObject>() {
      @Override
      public EObject apply(final ISemanticRegion it) {
    ...
    AccessibleRequiredGrammarTerminalsPresentEnsurer _fakeEnsurer = this.getFakeEnsurer();
    final Procedure1<AccessibleRequiredGrammarTerminalsPresentEnsurer> _function_6 = new Procedure1<AccessibleRequiredGrammarTerminalsPresentEnsurer>() {
      @Override
      public void apply(final AccessibleRequiredGrammarTerminalsPresentEnsurer it) {
