...
public class TestContainsGrammarElementDeep extends ARegion {
  ...
  public void emptyGrammarMapDirect() {
    ...
    final Function1<ISemanticRegion, AbstractElement> _function = new Function1<ISemanticRegion, AbstractElement>() {
      @Override
      public AbstractElement apply(final ISemanticRegion it) {
        EObject _grammarElement = it.getGrammarElement();
        return ((AbstractElement) _grammarElement);
      }
    };
