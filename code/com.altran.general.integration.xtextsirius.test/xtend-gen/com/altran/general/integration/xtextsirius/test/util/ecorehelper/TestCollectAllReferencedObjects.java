...
public class TestCollectAllReferencedObjects extends ATestEcoreHelper {
  ...
  public void empty() {
    ...
    final List<EObject> objects = this.getAccessibleEcoreHelper().collectAllReferencedObjectsA(event).collect(Collectors.<EObject>toList());
  ...
  public void simple() {
    ...
    final List<EObject> objects = this.getAccessibleEcoreHelper().collectAllReferencedObjectsDeepA(guard).collect(Collectors.<EObject>toList());
