 ...
 * </p>
 * <ul>
 * <li>{@link com.altran.general.integration.xtextsirius.model.eef.eefxtext.impl.EefXtextSingleLineModelDescriptionImpl#getInjectorId
 * <em>Injector Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EefXtextSingleLineModelDescriptionImpl extends EEFTextDescriptionImpl
	...
	public void setInjectorId(final String newInjectorId) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET,
					EefxtextPackage.EEF_XTEXT_SINGLE_LINE_MODEL_DESCRIPTION__INJECTOR_ID, oldInjectorId,
					this.injectorId));
		}
	}
	...
	public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
		switch (featureID) {
			case EefxtextPackage.EEF_XTEXT_SINGLE_LINE_MODEL_DESCRIPTION__INJECTOR_ID:
		...
		if (baseClass == IEefXtextDescription.class) {
			switch (baseFeatureID) {
				case EefxtextPackage.IEEF_XTEXT_DESCRIPTION__INJECTOR_ID:
					return EefxtextPackage.EEF_XTEXT_SINGLE_LINE_MODEL_DESCRIPTION__INJECTOR_ID;
				default:
					return -1;
			}
		}
