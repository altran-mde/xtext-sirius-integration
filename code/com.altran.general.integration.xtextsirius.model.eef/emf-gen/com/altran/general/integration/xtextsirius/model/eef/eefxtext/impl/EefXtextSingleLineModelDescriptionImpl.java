 ...
 * <li>{@link com.altran.general.integration.xtextsirius.model.eef.eefxtext.impl.EefXtextSingleLineModelDescriptionImpl#getIgnoredNestedFeatures
 * <em>Ignored Nested Features</em>}</li>
 * <li>{@link com.altran.general.integration.xtextsirius.model.eef.eefxtext.impl.EefXtextSingleLineModelDescriptionImpl#getPrefixTerminalsExpression
 * <em>Prefix Terminals Expression</em>}</li>
 * <li>{@link com.altran.general.integration.xtextsirius.model.eef.eefxtext.impl.EefXtextSingleLineModelDescriptionImpl#getSuffixTerminalsExpression
...
public class EefXtextSingleLineModelDescriptionImpl extends IEefXtextDescriptionImpl
	...
	public EList<String> getIgnoredNestedFeatures() {
		if (this.ignoredNestedFeatures == null) {
			this.ignoredNestedFeatures = new EDataTypeEList<>(String.class, this,
					EefxtextPackage.EEF_XTEXT_SINGLE_LINE_MODEL_DESCRIPTION__IGNORED_NESTED_FEATURES);
		}
	...
	public void setPrefixTerminalsExpression(final String newPrefixTerminalsExpression) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET,
					EefxtextPackage.EEF_XTEXT_SINGLE_LINE_MODEL_DESCRIPTION__PREFIX_TERMINALS_EXPRESSION,
	...
	public void setSuffixTerminalsExpression(final String newSuffixTerminalsExpression) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET,
					EefxtextPackage.EEF_XTEXT_SINGLE_LINE_MODEL_DESCRIPTION__SUFFIX_TERMINALS_EXPRESSION,
	...
	public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
		switch (featureID) {
			case EefxtextPackage.EEF_XTEXT_SINGLE_LINE_MODEL_DESCRIPTION__EDITABLE_FEATURES:
				return getEditableFeatures();
			case EefxtextPackage.EEF_XTEXT_SINGLE_LINE_MODEL_DESCRIPTION__IGNORED_NESTED_FEATURES:
				return getIgnoredNestedFeatures();
			case EefxtextPackage.EEF_XTEXT_SINGLE_LINE_MODEL_DESCRIPTION__PREFIX_TERMINALS_EXPRESSION:
				return getPrefixTerminalsExpression();
			case EefxtextPackage.EEF_XTEXT_SINGLE_LINE_MODEL_DESCRIPTION__SUFFIX_TERMINALS_EXPRESSION:
		...
		if (baseClass == IEefXtextModelDescription.class) {
			switch (baseFeatureID) {
				case EefxtextPackage.IEEF_XTEXT_MODEL_DESCRIPTION__EDITABLE_FEATURES:
					return EefxtextPackage.EEF_XTEXT_SINGLE_LINE_MODEL_DESCRIPTION__EDITABLE_FEATURES;
				case EefxtextPackage.IEEF_XTEXT_MODEL_DESCRIPTION__IGNORED_NESTED_FEATURES:
					return EefxtextPackage.EEF_XTEXT_SINGLE_LINE_MODEL_DESCRIPTION__IGNORED_NESTED_FEATURES;
				case EefxtextPackage.IEEF_XTEXT_MODEL_DESCRIPTION__PREFIX_TERMINALS_EXPRESSION:
					return EefxtextPackage.EEF_XTEXT_SINGLE_LINE_MODEL_DESCRIPTION__PREFIX_TERMINALS_EXPRESSION;
				case EefxtextPackage.IEEF_XTEXT_MODEL_DESCRIPTION__SUFFIX_TERMINALS_EXPRESSION:
					return EefxtextPackage.EEF_XTEXT_SINGLE_LINE_MODEL_DESCRIPTION__SUFFIX_TERMINALS_EXPRESSION;
				default:
					return -1;
			}
		}
