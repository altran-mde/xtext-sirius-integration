 ...
 * {org.eclipse.xtext.example.fowlerdsl.ui.StatemachineUiModule}
 */
@SuppressWarnings("all")
public abstract class AbstractStatemachineUiModule
		extends org.eclipse.xtext.common.types.ui.DefaultCommonTypesUiModule {
	
	public AbstractStatemachineUiModule(final AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureResourceUIServiceLabelProvider(final com.google.inject.Binder binder) {
		binder.bind(org.eclipse.jface.viewers.ILabelProvider.class)
				...
				.to(org.eclipse.xtext.example.fowlerdsl.ui.labeling.StatemachineDescriptionLabelProvider.class);
	}
	...
	public void configureContentAssistLexerProvider(final com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.example.fowlerdsl.ui.contentassist.antlr.internal.InternalStatemachineLexer.class)
				.toProvider(org.eclipse.xtext.parser.antlr.LexerProvider.create(
						org.eclipse.xtext.example.fowlerdsl.ui.contentassist.antlr.internal.InternalStatemachineLexer.class));
	}
	...
	public void configureContentAssistLexer(final com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.ui.editor.contentassist.antlr.internal.Lexer.class)
				...
				.to(org.eclipse.xtext.example.fowlerdsl.ui.contentassist.antlr.internal.InternalStatemachineLexer.class);
	}
	...
	// contributed by org.eclipse.xtext.ui.generator.compare.CompareFragment
	public void configureCompareViewerTitle(final com.google.inject.Binder binder) {
		binder.bind(String.class)
				.annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.UIBindings.COMPARE_VIEWER_TITLE))
				.toInstance("Statemachine Compare");
	}
