...
// Entry rule entryRuleInlineClassModel
entryRuleInlineClassModel returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getInlineClassModelRule()); }
	iv_ruleInlineClassModel=ruleInlineClassModel
	{ $current=$iv_ruleInlineClassModel.current; }
	EOF;

// Rule InlineClassModel
ruleInlineClassModel returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	{
		$current = $this_ClassModel_0.current;
