...
public class InternalHtmlLangLexer extends Lexer {
    ...
    public InternalHtmlLangLexer(CharStream input) {
        this(input, new RecognizerSharedState());
    }
    public InternalHtmlLangLexer(CharStream input, RecognizerSharedState state) {
        super(input,state);
    ...
    public final void mRULE_HTMLSTRING() throws RecognitionException {
        try {
            int _type = RULE_HTMLSTRING;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalHtmlLang.g:718:17: ( (~ ( ( '<' | '>' | '\\t' | '\\r' | '\\n' ) ) )* )
            // InternalHtmlLang.g:718:19: (~ ( ( '<' | '>' | '\\t' | '\\r' | '\\n' ) ) )*
            {
            // InternalHtmlLang.g:718:19: (~ ( ( '<' | '>' | '\\t' | '\\r' | '\\n' ) ) )*
            loop1:
            do {
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalHtmlLang.g:720:9: ( ( '\\t' | '\\r' | '\\n' )+ )
            // InternalHtmlLang.g:720:11: ( '\\t' | '\\r' | '\\n' )+
            {
            // InternalHtmlLang.g:720:11: ( '\\t' | '\\r' | '\\n' )+
            int cnt2=0;
            loop2:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalHtmlLang.g:722:16: ( . )
            // InternalHtmlLang.g:722:18: .
            {
            matchAny(); 
    ...
    public void mTokens() throws RecognitionException {
        // InternalHtmlLang.g:1:8: ( T__7 | T__8 | T__9 | T__10 | T__11 | T__12 | T__13 | T__14 | T__15 | T__16 | T__17 | T__18 | T__19 | T__20 | T__21 | T__22 | T__23 | T__24 | T__25 | T__26 | RULE_HTMLSTRING | RULE_WS | RULE_ANY_OTHER )
        int alt3=23;
    ...
    static final String DFA3_minS =
        "\1\0\1\57\4\uffff\1\145\1\142\2\uffff\1\76\7\uffff\1\145\2\uffff\1\76\12\uffff";
    static final String DFA3_maxS =
        "\1\uffff\1\165\4\uffff\1\164\1\165\2\uffff\1\157\7\uffff\1\164\2\uffff\1\157\12\uffff";
    static final String DFA3_acceptS =
        "\2\uffff\2\25\1\26\1\27\2\uffff\1\5\1\7\1\uffff\1\13\1\15\1\17\1\23\1\26\1\1\1\3\1\uffff\1\6\1\10\1\uffff\1\14\1\16\1\20\1\24\1\11\1\21\1\2\1\4\1\12\1\22";
    static final String DFA3_specialS =
        "\1\0\37\uffff}>";
    static final String[] DFA3_transitionS = {
            "\11\2\2\4\2\2\1\4\56\2\1\1\1\2\1\5\uffc1\2",
            ...
            "",
            "\1\21\16\uffff\1\20",
            "\1\25\5\uffff\1\22\1\31\2\uffff\1\30\3\uffff\1\26\2\uffff\1\24\1\23\1\27",
            "",
            "",
            "\1\33\60\uffff\1\32",
            "",
        ...
        public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
            ...
            switch ( s ) {
                    case 0 : 
                        ...
                        else if ( ((LA3_0>='\u0000' && LA3_0<='\b')||(LA3_0>='\u000B' && LA3_0<='\f')||(LA3_0>='\u000E' && LA3_0<=';')||LA3_0=='='||(LA3_0>='?' && LA3_0<='\uFFFF')) ) {s = 2;}
