...
public class HtmlLangSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(final int classifierID, final EObject theEObject) {
		switch (classifierID) {
			case HtmlLangPackage.HTML: {
				final Html html = (Html) theEObject;
			...
			case HtmlLangPackage.HEAD: {
				final Head head = (Head) theEObject;
			...
			case HtmlLangPackage.HEADER: {
				final Header header = (Header) theEObject;
			...
			case HtmlLangPackage.TITLE: {
				final Title title = (Title) theEObject;
				T result = caseTitle(title);
				if (result == null) {
					result = caseHeader(title);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case HtmlLangPackage.BODY: {
				final Body body = (Body) theEObject;
			...
			case HtmlLangPackage.BODY_CONTENTS: {
				final BodyContents bodyContents = (BodyContents) theEObject;
			...
			case HtmlLangPackage.PARAGRAPH: {
				final Paragraph paragraph = (Paragraph) theEObject;
				T result = caseParagraph(paragraph);
				if (result == null) {
					result = caseBodyContents(paragraph);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case HtmlLangPackage.UNORDERED_LIST: {
				final UnorderedList unorderedList = (UnorderedList) theEObject;
				T result = caseUnorderedList(unorderedList);
				if (result == null) {
					result = caseBodyContents(unorderedList);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case HtmlLangPackage.LIST_ITEM: {
				final ListItem listItem = (ListItem) theEObject;
			...
			case HtmlLangPackage.TEXT_ELEMENT: {
				final TextElement textElement = (TextElement) theEObject;
			...
			case HtmlLangPackage.FREEFORM_TEXT: {
				final FreeformText freeformText = (FreeformText) theEObject;
				T result = caseFreeformText(freeformText);
				if (result == null) {
					result = caseTextElement(freeformText);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case HtmlLangPackage.BOLD: {
				final Bold bold = (Bold) theEObject;
			...
			case HtmlLangPackage.ITALICS: {
				final Italics italics = (Italics) theEObject;
				T result = caseItalics(italics);
				if (result == null) {
					result = caseTextElement(italics);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
	 ...
	 * <em>Html</em>'. <!-- begin-user-doc --> This implementation returns null;
	 ...
	 * @generated
	 */
	public T caseHtml(final Html object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Head</em>'. <!-- begin-user-doc --> This implementation returns null;
	 * returning a non-null result will terminate the switch. <!-- end-user-doc
	 * -->
	 *
	 * @param object
	 ...
	 * @generated
	 */
	public T caseHead(final Head object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Header</em>'. <!-- begin-user-doc --> This implementation returns
	 ...
	 * @generated
	 */
	public T caseHeader(final Header object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseTitle(final Title object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Body</em>'. <!-- begin-user-doc --> This implementation returns null;
	 * returning a non-null result will terminate the switch. <!-- end-user-doc
	 * -->
	 *
	 * @param object
	 ...
	 * @generated
	 */
	public T caseBody(final Body object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Body Contents</em>'. <!-- begin-user-doc --> This implementation
	 ...
	 * @generated
	 */
	public T caseBodyContents(final BodyContents object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseParagraph(final Paragraph object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Unordered List</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 *
	 * @param object
	 ...
	 * @generated
	 */
	public T caseUnorderedList(final UnorderedList object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseListItem(final ListItem object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Text Element</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 *
	 * @param object
	 ...
	 * @generated
	 */
	public T caseTextElement(final TextElement object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Freeform Text</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 *
	 * @param object
	 ...
	 * @generated
	 */
	public T caseFreeformText(final FreeformText object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Bold</em>'. <!-- begin-user-doc --> This implementation returns null;
	 * returning a non-null result will terminate the switch. <!-- end-user-doc
	 * -->
	 *
	 * @param object
	 ...
	 * @generated
	 */
	public T caseBold(final Bold object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Italics</em>'. <!-- begin-user-doc --> This implementation returns
	 * null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 *
	 * @param object
	 ...
	 * @generated
	 */
	public T caseItalics(final Italics object) {
		return null;
	}
