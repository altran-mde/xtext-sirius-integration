...
public interface ConstantRef extends Value {
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Constant</em>' reference isn't clear, there
	 ...
	 * {@link org.eclipse.xtext.example.fowlerdsl.statemachine.ConstantRef#getConstant
	 * <em>Constant</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 *
	 * @param value
	 *            the new value of the '<em>Constant</em>' reference.
	 * @see #getConstant()
	 * @generated
	 */
