...
public abstract class AbstractHtmlLangUiModule extends DefaultUiModule {
	...
	public AbstractHtmlLangUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(HtmlLangDescriptionLabelProvider.class);
	}
