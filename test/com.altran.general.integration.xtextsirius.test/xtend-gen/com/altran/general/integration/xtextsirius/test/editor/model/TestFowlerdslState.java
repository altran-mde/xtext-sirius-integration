...
public class TestFowlerdslState extends ATestFowlerdslModel {
  ...
  public void changeFirst() {
    ...
    this.assertModelEdit(_last, 
      this.model, 
      "state A things t1 1 t2 2 t4 4 end", 
      "state A things t3 3 t2 2 t4 4 end", _doubleArrow);
  }
  ...
  public void changeMiddle() {
    ...
    this.assertModelEdit(_last, 
      this.model, 
      "state A things t1 1 t2 2 t4 4 end", 
      "state A things t1 1 t3 3 t4 4 end", _doubleArrow);
  }
  ...
  public void changeBoth() {
    ...
    this.assertModelEdit(_last, 
      this.model, 
      "state A things t1 1 t2 2 t4 4 end", 
      "state A things t2 2 t3 3 t4 4 end", _doubleArrow);
  }
  ...
  public void removeLast() {
    ...
    this.assertModelEdit(_last, 
      this.model, 
      "state A things t1 1 t2 2 t4 4 end", 
      "state A things t1 1 t2 2 end", _doubleArrow);
  }
  ...
  public void removeFirst() {
    ...
    this.assertModelEdit(_last, 
      this.model, 
      "state A things t1 1 t2 2 t4 4 end", 
      "state A things t2 2 t4 4 end", _doubleArrow);
  }
  ...
  public void insertFirst() {
    ...
    final Procedure1<State> _function = (State it) -> {
      ...
      Thing _doubleArrow_2 = ObjectExtensions.<Thing>operator_doubleArrow(_createThing_2, _function_3);
      _things_2.add(_doubleArrow_2);
      EList<Thing> _things_3 = it.getThings();
      Thing _createThing_3 = this.statemachineFactory.createThing();
      final Procedure1<Thing> _function_4 = (Thing it_1) -> {
        it_1.setName("t4");
        ValueGuard _createValueGuard = this.statemachineFactory.createValueGuard();
        final Procedure1<ValueGuard> _function_5 = (ValueGuard it_2) -> {
          IntLiteral _createIntLiteral = this.statemachineFactory.createIntLiteral();
          final Procedure1<IntLiteral> _function_6 = (IntLiteral it_3) -> {
            it_3.setValue(4);
          };
          IntLiteral _doubleArrow_3 = ObjectExtensions.<IntLiteral>operator_doubleArrow(_createIntLiteral, _function_6);
          it_2.setCond(_doubleArrow_3);
        };
        ValueGuard _doubleArrow_3 = ObjectExtensions.<ValueGuard>operator_doubleArrow(_createValueGuard, _function_5);
        it_1.setGuard(_doubleArrow_3);
      };
      Thing _doubleArrow_3 = ObjectExtensions.<Thing>operator_doubleArrow(_createThing_3, _function_4);
      _things_3.add(_doubleArrow_3);
    };
    State _doubleArrow = ObjectExtensions.<State>operator_doubleArrow(_createState, _function);
    this.assertModelEdit(_last, 
      this.model, 
      "state A things t1 1 t2 2 t4 4 end", 
      "state A things t3 3 t1 1 t2 2 t4 4 end", _doubleArrow);
  }
  ...
  public void insertLast() {
    ...
    this.assertModelEdit(_last, 
      this.model, 
      "state A things t1 1 t2 2 t4 4 end", 
      "state A things t1 1 t2 2 t4 4 t3 3 end", _doubleArrow);
  }
