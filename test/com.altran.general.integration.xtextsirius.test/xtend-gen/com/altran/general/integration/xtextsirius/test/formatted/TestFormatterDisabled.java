...
public class TestFormatterDisabled extends ATestXtextSiriusModel<ClassModel> {
  @Extension
  ...
  public static void loadEKeyDsl() {
    ...
    TestFormatterDisabled.injector = new ClassesStandaloneSetup().createInjectorAndDoEMFRegistration();
  }
  ...
  public void pseudoEdit() {
    ...
    _builder_1.append("class B { + attr: integer [2..5]}");
    com.example.classes.Class _createClass = this._classesFactory.createClass();
    final Procedure1<com.example.classes.Class> _function = (com.example.classes.Class it) -> {
      it.setName("B");
      EList<Attribute> _attributes = it.getAttributes();
  ...
  public void edit() {
    ...
    _builder.append("class B { + attr : integer [2 ..5]}");
    StringConcatenation _builder_1 = new StringConcatenation();
    _builder_1.append("class B { + attr2: string [2 .. 4]}");
    com.example.classes.Class _createClass = this._classesFactory.createClass();
    final Procedure1<com.example.classes.Class> _function = (com.example.classes.Class it) -> {
      it.setName("B");
      EList<Attribute> _attributes = it.getAttributes();
  ...
  protected Injector getInjector() {
    return TestFormatterDisabled.injector;
  }
  ...
  protected IXtextSiriusModelDescriptor createModelDescriptor() {
    ...
    return new XtextSiriusModelDescriptor(TestFormatterDisabled.injector, _doubleArrow);
  }
}
