 ...
 */
package com.altran.general.integration.xtextsirius.test.reflang.ide.contentassist.antlr;

import com.altran.general.integration.xtextsirius.test.reflang.ide.contentassist.antlr.internal.InternalRefLangParser;
...
public class RefLangParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(RefLangGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, RefLangGrammarAccess grammarAccess) {
	...
	@Override
	protected InternalRefLangParser createParser() {
		InternalRefLangParser result = new InternalRefLangParser(null);
