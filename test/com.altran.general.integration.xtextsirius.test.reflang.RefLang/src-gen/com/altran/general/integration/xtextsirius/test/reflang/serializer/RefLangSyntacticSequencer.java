...
public class RefLangSyntacticSequencer extends AbstractSyntacticSequencer {

	protected RefLangGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (RefLangGrammarAccess) access;
	}
